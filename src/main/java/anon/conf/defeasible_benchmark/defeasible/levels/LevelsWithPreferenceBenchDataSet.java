package anon.conf.defeasible_benchmark.defeasible.levels;
...
public class LevelsWithPreferenceBenchDataSet extends DefeasibleBenchDataSet {
	private static final String NAME = "LevelsBench";
	
	private int[] sizes;
	private Iterable<? extends Object> KBGeneratorIterable;
	
	public LevelsWithPreferenceBenchDataSet(int[] sizes) {
		this.sizes = sizes;
