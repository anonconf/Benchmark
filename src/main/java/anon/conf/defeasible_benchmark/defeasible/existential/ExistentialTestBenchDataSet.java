package anon.conf.defeasible_benchmark.defeasible.existential;
...
public class ExistentialTestBenchDataSet extends DefeasibleBenchDataSet {
	private static final String NAME = "ChainFESBench";
	
	private int[] sizes;
	private Iterable<? extends Object> KBGeneratorIterable;
	
	public ExistentialTestBenchDataSet(int[] sizes) {
		this.sizes = sizes;
